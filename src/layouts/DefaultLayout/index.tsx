      ...
      submenus: [
        {
          ...
          (
            <div
              ...
              className=
                {
                  getIsActivePathname('/whatsapp/grupos') ?
        ...
        (
          <div
            ...
            className=
              {
                getIsActivePathname('/whatsapp/categorias') ?
                styles.menuItemActive : styles.menuItem
              }
          >
      ...
      submenus: [
        {
          ...
          (
            <div
              key="/discord/servidores"
              className=
                {
                  getIsActivePathname('/discord/servidores') ?
                  styles.menuItemActive : styles.menuItem
                }
            >
              <Link to='/discord/servidores'>Servidores</Link>
            </div>
          ),
          key: '/discord/servidores',
        },
        {
          ...
          (
            <div
              ...
              className=
                {
                  getIsActivePathname('/discord/categorias') ?
                  styles.menuItemActive : styles.menuItem
                }
            >
      ...
      submenus: [
        {
          ...
          (
            <div
              ...
              className=
                {
                  getIsActivePathname('/telegram/grupos') ?
                  styles.menuItemActive : styles.menuItem
                }
            >
        ...
        },
        {
          label:  (
            <div
              ...
              className=
                {
                  getIsActivePathname('/telegram/categorias') ?
                  styles.menuItemActive : styles.menuItem
                }
            >
