...
const UserTable: React.FC<{ dataSource: IUsersProps[]; pagination: TableProps<IUsersProps>['pagination']; onDelete: (uuid: string) => Promise<void>}> = ({ dataSource, pagination, onDelete}) => {
